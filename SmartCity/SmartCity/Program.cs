        ...
        while (running)
        {
            ...
            switch (choice)
            {
                case "1":
                    ...
                    controller.OptimizeCityOperation(); // Facade orqali bir nechta tizimni boshqaradi
                    break;

                case "2":
                    Console.WriteLine("\n--- Tanlov: 2. Sensorlar Statusini Ko'rish ---");
                    controller.DisplaySensorStatus(); // Abstract Factory mahsulotlarini ishlatadi
                    break;

                case "3":
                    Console.WriteLine("\n--- Tanlov: 3. Ob-havo Ma'lumotlarini Yangilash ---");
                    controller.UpdateWeatherInfo(); // Adapter orqali tashqi xizmatni chaqiradi
                    break;
